...
name_dataset = "SKCM-preproc-filter"
...
output = shap.force_plot(explainer.expected_value[0], shap_values[0][0,:], X_test[0,:], feature_names= features, matplotlib = False, show=False)

shap.save_html(open("/home/ogreyesp/Desktop/firstPrediction.html", "w"), output)

# Explain individual predictions
output = shap.force_plot(explainer.expected_value[0], shap_values[0][1,:], X_test[1,:], feature_names= features, matplotlib = False, show=False)
...
#shap.summary_plot(shap_values[0], X[train_indexes], show= False, feature_names= features, class_names= ["Normal", "Tumor"])

#plt.savefig("/home/ogreyesp/Desktop/summary_plot1.svg", format="svg")

shap.summary_plot(shap_values[0], X[train_indexes], show= False, feature_names= features, plot_type = "bar", class_names= ["Normal", "Tumor"])
